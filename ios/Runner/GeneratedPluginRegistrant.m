...
#if __has_include(<stream_video_screen_sharing/StreamVideoScreenSharingPlugin.h>)
#import <stream_video_screen_sharing/StreamVideoScreenSharingPlugin.h>
#else
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [StreamVideoScreenSharingPlugin registerWithRegistrar:[registry registrarForPlugin:@"StreamVideoScreenSharingPlugin"]];
